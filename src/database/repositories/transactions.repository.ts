import { GetDasboardDTO, GetFinancialEvolutionDTO, IndexTransactionsDTO } from "../../dtos/transactions.dto"
...
export class TransactionsRepository {
    ...
    async getBalance({beginDate, endDate}: GetDasboardDTO): Promise<Balance> {
    ...
    async getExpenses({ 
        beginDate, 
        endDate 
    }: GetDasboardDTO): Promise<Expense[]> {
